...
<div class="container-fluid">
  <a class="navbar-brand" href="index.jsp"><h3><i>OMU</i></h3></a>
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    ...
    <form class="form-inline my-2 my-lg-0" action="ProductOperationServlet" method="post">
      ...
      <button type="submit" class="btn btn-light" style="color:#330099"><b>Search</b></button>
    </form>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <p style="font-size:23px;">
            <b>
                <img src="images/phone-call.png" style="width:27px;" alt="img">+90 555 555 55 55<br>
                <img src="images/mail-contact.png" style="width:29px;" alt="img">ekocak227@gmail.com
            </b>
        </p>
        </div>
      </div>
